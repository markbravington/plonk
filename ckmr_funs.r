...
function( params, log_prior=NULL, cheat=NULL){
  ...
  init <- exp( -aslope_y0 * ALL_AGES) # actually it's not *all* ages, but AminC up (ie recruited to fishery)
...
return( SIGNAL_BADFIT)
  ...
  # Cond age of a Mother at B1: FWIW also do-able in basic R, without autoloopery etc
...
<environment: 0x0000000032a71cd0>
